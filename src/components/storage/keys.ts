...
export namespace StorageBindings {
  ...
  export const STORAGE_OPTIONS =
    BindingKey.create<StorageProviderConfig>('storage.options');
  export const STORAGE_PROVIDER =
    BindingKey.create<StorageProvider>('storage.provider');

  export const NAME_PROVIDER = BindingKey.create<GetFileName>('storage.name');

  export const REST_DECORATORS =
    BindingKey.create<ClassMixinDecoratorOptions>('storage.decorator');
}
